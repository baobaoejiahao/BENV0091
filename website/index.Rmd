...
- **[Carbon Intensity API:](nbs/carbon_intensity.html)** usage of the National Grid Carbon Intensity API
- **[Met Office API:](nbs/met_office.html)** usage of the Met Office API for retrieving weather forecasts

#### Lecture 9

- **[Tidymodels:](nbs/tidymodels_vw.html)** using tidymodels for non-intrusive load monitoring analysis